...
RUN git clone https://github.com/eigerco/substrate-node-template-move-vm-test && cd substrate-node-template-move-vm-test && git checkout pallet-move && cargo build --release --features runtime-benchmarks
